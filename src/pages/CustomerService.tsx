    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="px-4 py-6 space-y-4">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-border text-center">
          <div className="w-16 h-16 bg-cyan-deep rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        >
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 bg-cyan-deep rounded-full flex items-center justify-center">
